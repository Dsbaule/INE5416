...
totienteEuler(N,K) :- N1 is N - 1, K is totienteEuler(N,N1,K).

totienteEulerR(NO,N,0) :- N < 1.
totienteEulerR(NO,N,K) :- N >= 1, coprimos(NO,N), N1 is N - 1, totienteEuler(NO,N1,K1), K is 1 + K1.
totienteEulerR(NO,N,K) :- N >= 1, not(coprimos(NO,N)), N1 is N - 1, totienteEuler(NO,N1,K).
